import {removeValidationErrorMessages} from "../../general/ajax/ajax-util/fail-handler.js?v=4.0.1";
import {
    contentEditableFieldValueIsValid,
    disableEditableField,
    makeFieldEditable
} from "../../general/page-component/contenteditable/contenteditable-main.js?v=4.0.1";
import {submitUpdate} from "../../general/ajax/submit-update-data.js?v=4.0.1";
